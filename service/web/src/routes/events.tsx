...
import { Search, ChevronDown, ChevronRight, ChevronLeft, ChevronsLeft, ChevronsRight } from 'lucide-react'
...
import { APP_COLORS, PAGE_SIZE } from '#/lib/constants'
import { formatTime } from '#/lib/format'

function PayloadViewer({ payload }: { payload: Record<string, unknown> }) {
  return (
    <ScrollArea className="mt-2 max-h-64">
      <pre className="rounded-md bg-muted/50 p-3 text-xs font-mono">
